...
class FactorizedLogLikelihood(ObjectiveFuctionGPAtom):
    def __init__(self,get_prior_mean=False,modification=False,ngrid=80,bounds=None,noise_method="finegrid",method_kwargs={},**kwargs):
        """ 
    ...
    def make_noise_list(self,model,X,Y,**kwargs):
        ...
        self.bounds.update_bounds(model,X,Y,['noise'])
    ...
    def copy(self):
        clone=self.__class__(get_prior_mean=self.get_prior_mean,modification=self.modification,
                             ...
                             noise_method=self.noise_method,method_kwargs=self.method_kwargs)
        return clone
    
    def __repr__(self):
        return "{}(get_prior_mean={},modification={},ngrid={},noise_method={})".format(self.__class__.__name__,self.get_prior_mean,self.modification,self.ngrid,self.noise_method)
