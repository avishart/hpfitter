...
class LengthBoundaries(HPBoundaries):
    def __init__(self,bounds_dict={},scale=1.0,log=True,max_length=True,use_derivatives=False,**kwargs):
        ...
        """
        super().__init__(bounds_dict=bounds_dict,scale=scale,log=log,**kwargs)
    ...
    def __repr__(self):
        return "LengthBoundaries(bounds_dict={},scale={},log={},max_length={},use_derivatives={})".format(self.bounds_dict,self.scale,self.log,self.max_length,self.use_derivatives)
