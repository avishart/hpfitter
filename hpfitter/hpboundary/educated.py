...
class EducatedBoundaries(RestrictedBoundaries):
    ...
    def __repr__(self):
        return "EducatedBoundaries(bounds_dict={},scale={},log={},max_length={},use_derivatives={},use_prior_mean={})".format(self.bounds_dict,self.scale,self.log,self.max_length,self.use_derivatives,self.use_prior_mean)
